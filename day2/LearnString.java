...
//		String text4 = new String("Testleaf Software Solutions");
		...
		String f = "Sam";
	    String g = "David Lazarus";
		/*
		 * String xy = f.concat(g); System.out.println(xy);
		 */
	    System.out.println(f);
	    
	    // String is mutable by using StringBuffer or StringBuilder Class
	    
	    StringBuffer gg = new StringBuffer("Naveen");
	    StringBuffer hh = new StringBuffer("Elumalai");
	    gg.append(hh);
	    System.out.println(gg);
	    
	    // Using charAt in a String 
	    
	    String st = "Sam David Lazarus";
